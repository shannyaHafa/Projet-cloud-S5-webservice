...
public class DetailAnnonce extends Annonce {
    ...
    public DetailAnnonce[] listeAnnonceValider() throws Exception {
        DetailAnnonce[] listes = null;
        try(Connection connection = new Connexion().getConnection()) {
            listes = (DetailAnnonce[]) dao().select("Annoncevalider", this, connection);
        }
        catch(Exception exception) {
            throw exception;
        }
    ...
    public DetailAnnonce[] historiqueAnnonce(String idUser) throws Exception {
        DetailAnnonce[] listes = null;
        DetailAnnonce annonce = new DetailAnnonce();
        try(Connection connection = new Connexion().getConnection()) {
            annonce.setIdUtilisateur(idUser);
            listes = (DetailAnnonce[]) dao().select("HistoriqueAnnonce", annonce, connection);
        }
        catch(Exception exception) {
            throw exception;
        }
    ...
    public DetailAnnonce getById(String idAnnonce) throws Exception {
        DetailAnnonce detailAnnonce = new DetailAnnonce();
        DetailAnnonce[] listes = null;
        DetailAnnonce annonce = new DetailAnnonce();
        try(Connection connection = new Connexion().getConnection()) {
            annonce.setId(idAnnonce);
            listes = (DetailAnnonce[]) dao().select("AnnonceValider", annonce, connection);
    ...
    public DetailAnnonce[] getAnnonceUser(String liste, String idUser) throws Exception {
        DetailAnnonce[] listes = null;
        DetailAnnonce annonce = new DetailAnnonce();
        try(Connection connection = new Connexion().getConnection()) {
            annonce.setIdUtilisateur(idUser);
            listes = (DetailAnnonce[]) dao().select(liste, annonce, connection);
        }
        catch(Exception exception) {
            throw exception;
        }
